...
--- @author DemiAutomatic
--- @method OpxAppearance.Locale.register
--- @description Merges a language's strings into its catalogue.
--- @param code {string}
--- @param strings {table<string, string>}
function OpxAppearance.Locale.register(code, strings)
...
--- @author DemiAutomatic
--- @method OpxAppearance.Locale.Set
--- @description Selects the catalogue player-facing text is read from.
--- @param code {string}
--- @returns {boolean}
function OpxAppearance.Locale.Set(code)
...
Locale.Set(OPX_APPEARANCE_CONFIG and OPX_APPEARANCE_CONFIG.LOCALE)
